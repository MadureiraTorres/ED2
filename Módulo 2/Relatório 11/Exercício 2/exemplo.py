...
if __name__ == "__main__":
    ...
    # lista com elementos
    lista = ['Edgar Codd', 'arvore', 'VonNeumann', 'GeorgeBoole']
    print(lista)
    
    # procurar elementos que existem na lista
    ret = buscaBinaria(arrayList = lista, query="Edgar Codd")
    print(ret)
    ret = buscaBinaria(arrayList = lista, query="VonNeumann")
    print(ret)

    # procurar um elemento que nao exista na lista
    ret = buscaBinaria(arrayList = lista, query = "blablabla")
    print(ret)
